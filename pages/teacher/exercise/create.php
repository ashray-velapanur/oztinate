            ...
            <div class="col-md-4">
                ...
                <form role="form" method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="instruction" type="text"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="minimumDuration">Minimim Duration</label>
                        <input class="form-control" name="minDuration" type="number" min="0">
                    </div>
                    <div class="form-group">
                        <label for="practiceDuration">Practice Duration</label>
                        <input class="form-control" name="practiceDuration" type="number" min="0">
                    </div>
                    <div class="form-group">
